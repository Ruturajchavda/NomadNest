...
import com.example.nomadnest.databinding.ItemPlacesBinding;
...
public class PlacesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ItemPlacesBinding binding;
    ...
    public PlacesAdapter(ArrayList<Places> placesArrayList, Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding = ItemPlacesBinding.inflate(layoutInflater, parent, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (viewItemInterface != null) {
                    viewItemInterface.OnItemShare(holder.getAdapterPosition(), places);
                }
            }
        });
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull ItemPlacesBinding binding) {
